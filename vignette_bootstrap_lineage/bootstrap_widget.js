...
function render({ model, el }) {
  const defaultData = model.get('default_data') || '12.1, 14.3, 11.8, 15.9, 13.2, 10.7, 16.4, 12.9, 14.8, 11.2, 13.6, 15.1';
  ...
  scriptTag.onload = async () => {
    try {
      ...
      btn.onclick = () => {
        ...
        // two-way sync back into the widget model, in case a host page
        // or future directive wants to read the result back out
