...
#
# Run from inside vignette_meta_analysis_lineage/, after `pip install mystmd`
...
# -- a build meant to live at .../DeScideratum/meta-analysis-vignette/ needs
...
export BASE_URL="/DeScideratum/meta-analysis-vignette"
...
echo "== Staging output =="
REPO_ROOT="$(cd .. && pwd)"
DEST="$REPO_ROOT/docs/meta-analysis-vignette"
...
echo "== Done =="
echo "Staged at $DEST"
echo "Next: git add docs/meta-analysis-vignette, commit, push."
