...
#
# Run from inside vignette_multiple_testing_lineage/, after `pip install mystmd`
...
# -- a build meant to live at .../DeScideratum/multiple-testing-vignette/ needs
...
export BASE_URL="/DeScideratum/multiple-testing-vignette"
...
echo "== Staging output =="
REPO_ROOT="$(cd .. && pwd)"
DEST="$REPO_ROOT/docs/multiple-testing-vignette"
...
echo "== Done =="
echo "Staged at $DEST"
echo "Next: git add docs/multiple-testing-vignette, commit, push."
